...
const locs_goronMountain = [
    new Location("Goron Mountain", "First Ascent",					Location.Type.Con_Lower, 9,2, 7,1, "B"),		//Lava cave
    ...
    new Location("Goron Mountain", "Small Pot Cave",				Location.Type.Generic, 9,1, 6,0, "TLL"),		//Empty (Secret?)
];

const locs_graveyard = [
    new Location("Graveyard", "Dungeon 7 (Ancient Crypt)",			Location.Type.Single, 0,13, 4,3, "B"),
    new Location("Graveyard", "Graveyard Secret",					Location.Type.Secret, 0,14, 4,1, "U"),			//Reward: Heart Container
...
const locs_horonVillage = [
    ...
    new Location("Horon Village", "Clock Shop Secret",				Location.Type.Secret, 7,13, 4,1, "RRR"),	//Reward: Sword Upgrade
    new Location("Horon Village", "Know-It-All Birds' Hut",			Location.Type.Single, 5,12, 4,1, "BRR"),
    new Location("Horon Village", "Mayor Ruul's House",				Location.Type.Single, 8,12, 4,4, "LLL"),	//As well as a bomb check, contains the Ruul Secret, which rewards a Ring Boc upgrade.
    new Location("Horon Village", "Mr. Left's House",				Location.Type.Con_Left, 9,15, 3,3, "LLL"),
...
const locs_mtCucco = [
    ...
    new Location("Mt. Cucco", "Floating Platform Cave",				Location.Type.Single, 15,1, 7,3, "RRR"),		//Generic?
    new Location("Mt. Cucco", "Great Fairy",						Location.Type.Generic, 14,1, 2,1, "RRR"),		//Generic - Great Fairy
    new Location("Mt. Cucco", "Mushroom Cave",						Location.Type.Single, 11,1, 7,2, "BL"),			//Talon
...
const locs_natzuRegion = [
    //Ricky Locs only 
    new Location("Natzu Region", "Small Platform Cave",				Location.Type.Single, 9,4, 7,1, "B"),		//Generic?
    new Location("Natzu Region", "Great Fairy",						Location.Type.Generic, 7,5, 2,3, "B"),		//Generic - Great Fairy
    new Location("Natzu Region", "Seed-Loving Scrub",				Location.Type.Single, 9,7, 8,4, "B"),		//Seed Satchel upgrade
];
...
const locs_spoolSwamp = [
    ...
    new Location("Spool Swamp", "Floodgate Passage",				Location.Type.Con_Left, 0,6, 1,2, "BBR"),		//Bushcrabs
...
const locs_sunkenCity = [
    new Location("Sunken City", "Flooded Cave",						Location.Type.Single, 15,4, 2,1, "B"),			//Generic?
    new Location("Sunken City", "Ingo's House",						Location.Type.Single, 13,4, 1,1, "BL"),
    new Location("Sunken City", "Potion Shop",						Location.Type.Single, 14,5, 4,4, "RRR"),
    new Location("Sunken City", "Man's House",						Location.Type.Single, 13,6, 2,3, "B"),			//Generic?
    new Location("Sunken City", "Master Diver's House",				Location.Type.Single, 13,5, 6,4, "B"),			//Generic?
    new Location("Sunken City", "Moblins' Hideout",					Location.Type.Single, 15,6, 7,5, "T"),			//Generic?
    new Location("Sunken City", "Woman's House",					Location.Type.Single, 15,3, 7,5, "BR"),			//Generic?
...
const locs_woodsOfWinter = [
    new Location("Woods of Winter", "Big Cave",						Location.Type.Single, 13,7, 2,1, "LLL"),			//Generic?
    ...
    new Location("Woods of Winter", "Small Fairy Cave",				Location.Type.Generic, 14,8, 3,4, "BL"),			//Generic - Fairy Grotto
...
const locs_subrosianVillage = [
    ...
    new Location("Subrosian Village", "Subrosian Chef's House",		Location.Type.Single, 2,2, 2,3, "B"),
    new Location("Subrosian Village", "Subrosian's House",			Location.Type.Single, 3,2, 8,4, "B"),
    new Location("Subrosian Village", "Subrosian Market",			Location.Type.Single, 5,4, 2.5,4, "B"),
    new Location("Subrosian Village", "Subrosian Smithy",			Location.Type.Single, 3,3, 6,4, "B"), 
];

const locs_subrosianVolcanoes = [
    new Location("Subrosian Volcanoes", "Big Empty Cave",					Location.Type.Single, 4,0, 7,6, "B"),
    ...
    new Location("Subrosian Volcanoes", "Locked Cave",						Location.Type.Generic, 2,1, 8,5, "B"),
    ...
    new Location("Subrosian Volcanoes", "Small Chest Cave",					Location.Type.Single, 1,1, 1,3, "B"),
    new Location("Subrosian Volcanoes", "Remains Volcano",					Location.Type.Single, 3,0, 7,6, "T")
];

const locs_subrosianWilds = [
    new Location("Subrosian Wilds", "House of Pirates",				Location.Type.Con_Lower, 2,7, 2,3, "LLL"),
    new Location("Subrosian Wilds", "House of Pirates",				Location.Type.Con_Upper, 2,7, 3,5, "RRR"),
...
const locs_templeOfSeasons = [
    new Location("Temple of Seasons", "Main Temple",				Location.Type.Single, 9,0, 4.5,4, "B"),
...
const locs_easternSubrosia = [
    new Location("Subrosian Village", "Bluff Ascent",					Location.Type.Con_Lower, 8,5, 2,5, "BR"),
    new Location("Subrosian Village", "Bluff Ascent",					Location.Type.Con_Upper, 8,5, 5,2, "TL"),
    new Location("Subrosian Village", "Great Furnace",					Location.Type.Single, 9,4, 5,6, "B"),
    new Location("Subrosian Village", "Sign-Loving Subrosian's House",	Location.Type.Single, 10,5, 4,2, "B"),
    new Location("Subrosian Village", "Portal (Great Furnace)",			Location.Type.Portal, 10,4, 4,3, "T")			//to Eyeglass Lake
];
...
const exemptions_holodrum = [
    "Horon Village - Mako Tree",
    "Northern Peak - Onox's Castle",
...
const exemptions_subrosia = [
    ...
    "Subrosian Village - Locked Passage - Left",
    "Subrosian Village - Locked Passage - Right",
    "Subrosian Wilds - Pirate Ship (Beached)",
    "Subrosian Wilds - Strange Brothers' House - Left",
    "Subrosian Wilds - Strange Brothers' House - Right"
];
