...
const locs_graveyard = [
    ...
    new Location("Graveyard", "Graveyard Secret",				Location.Type.Single, 0,14, 4,1, "U"),
...
const locs_mtCucco = [
    ...
    new Location("Mt. Cucco", "Floating Platform Cave",				Location.Type.Single, 15,1, 7,3, "RRR"),
    new Location("Mt. Cucco", "Great Fairy",						Location.Type.Generic, 14,1, 2,1, "RRR"),
    new Location("Mt. Cucco", "Mushroom Cave",						Location.Type.Single, 11,1, 7,2, "BL"),
    new Location("Mt. Cucco", "Mt. Cucco Portal",					Location.Type.Portal, 14,1, 4,5, "BRR"),		//to Subrosia SW
    new Location("Mt. Cucco", "Pyramid Jewel Cave",					Location.Type.Single, 13,1, 8,1, "TL"),
...
const locs_samasaDesert = [
    ...
    new Location("Samasa Desert", "Great Fairy",			Location.Type.Generic, 15,11, 5,1, "B"),
...
const locs_sunkenCity = [
    new Location("Sunken City", "Flooded Cave",						Location.Type.Single, 15,4, 2,1, "B"),
    ...
    new Location("Sunken City", "Man's House",						Location.Type.Single, 13,6, 2,3, "B"),
    new Location("Sunken City", "Master Diver's House",				Location.Type.Single, 13,5, 6,4, "B"),
    new Location("Sunken City", "Moblins' Hideout",					Location.Type.Single, 15,6, 7,5, "T"),
...
const locs_templeRemains = [
    new Location("Temple Remains", "Lava-Filled Cave",				Location.Type.Single, 5,1, 4,0, "B"),
    ...
    new Location("Temple Remains", "Portal (Temple Remains Lower)",	Location.Type.Portal, 5,2, 2,2, "B"),				//to Volcano N
    new Location("Temple Remains", "Portal (Temple Remains Upper)",	Location.Type.Portal, 4,0, 7,2, "B")				//Indoor, to Sword & Shield Maze
];

const locs_westernCoast = [
    new Location("Western Coast", "Great Fairy",					Location.Type.Generic, 3,13, 6,0, "B"),
    new Location("Western Coast", "Hero's Cave",					Location.Type.Con_Upper, 4,13, 7,5, "BR"),			//Dropdown
    new Location("Western Coast", "Hero's Cave",					Location.Type.Con_Lower, 4,13, 4,5, "BL"),			//Entrance
...
const locs_woodsOfWinter = [
    new Location("Woods of Winter", "Big Cave",						Location.Type.Single, 13,7, 2,1, "LLL"),
    new Location("Woods of Winter", "Dungeon 2 (Snake's Remains)",	Location.Type.Con_Lower, 13,8, 4,2, "LLL"),			//Front
